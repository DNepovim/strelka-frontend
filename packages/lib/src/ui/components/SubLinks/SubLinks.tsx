...
const SubLink = styled.a`
  ...
  @media ${min("l")} {
    padding: ${theme.size.small * 0.5}rem 1.2rem;
  }
`
...
const SubLinkPicture = styled.div`
  width: ${theme.size.base * 3}rem;
  min-width: ${theme.size.base * 3}rem;
  height: ${theme.size.base * 3}rem;
