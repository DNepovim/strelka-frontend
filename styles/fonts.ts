...
export const fonts = css`
  ...
  @font-face {
    ...
    src: url("https://cdn.skauting.cz/fonts/TheMix_LT_400.woff") format("woff"),
      ...
      url("https://cdn.skauting.cz/fonts/TheMix_LT_400.svg#themix")
        format("svg");
    font-weight: 400;
    font-style: normal;
  ...
  @font-face {
    ...
    src: url("https://cdn.skauting.cz/fonts/TheMix_LT_400i.woff") format("woff"),
      ...
      url("https://cdn.skauting.cz/fonts/TheMix_LT_400i.svg#themix")
        format("svg");
    font-weight: 400;
    font-style: italic;
    font-display: optional;
  ...
  @font-face {
    ...
    src: url("https://cdn.skauting.cz/fonts/TheMix_LT_700.woff") format("woff"),
      ...
      url("https://cdn.skauting.cz/fonts/TheMix_LT_700.svg#themix")
        format("svg");
    font-weight: 700;
    font-style: normal;
    font-display: optional;
  ...
  @font-face {
    ...
    src: url("https://cdn.skauting.cz/fonts/TheMix_LT_700i.woff") format("woff"),
      ...
      url("https://cdn.skauting.cz/fonts/TheMix_LT_700i.svg#themix")
        format("svg");
    font-weight: 700;
    font-style: italic;
    font-display: optional;
